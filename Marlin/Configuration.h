...
// Define this to set a custom name for your generic Prussia i3,
// #define CUSTOM_MENDEL_NAME "This Prussia i3"
...
// 3 is Prussia i3-parts thermistor (4.7k pullup)
...
#ifdef PIDTEMPBED
//120v 250W silicone heater into 4mm borosilicate (Prussia i3Max 1.5+)
...
#define EXTRUDE_MINTEMP 10 //prevent extrusion default is 170
...
#define INVERT_X_DIR true    // for Prussia i3 set to true, for Orca set to true
#define INVERT_Y_DIR true    // for Prussia i3 set to true, for Orca set to false
#define INVERT_Z_DIR true     // for Prussia i3 set to true, for Orca set to true
